...
const TEAMS: Record<TeamId, {
  ...
  android: {
    ...
    icon: Smartphone,
    color: "#10b981",
    description: "Best for native Android apps with Kotlin, Material 3, and APK output.",
    keywords: ["todo app", "chat app", "fitness", "weather", "camera", "android"],
    stack: "Kotlin + Jetpack Compose + Material 3",
    agents: [
      { name: "Architect", color: "#f59e0b", role: "architect", step: 1, description: "Plans MVVM architecture, data models, and navigation graph" },
      { name: "Builder", color: "#6b7280", role: "builder", step: 2, description: "Writes Kotlin code with Jetpack Compose composables" },
      { name: "UI Designer", color: "#7c3aed", role: "designer", step: 3, description: "Applies Material 3 design, theming, and animations" },
      { name: "QA", color: "#10b981", role: "qa", step: 4, description: "Checks for Kotlin null safety, Compose best practices" },
      { name: "Packager", color: "#ec4899", role: "packager", step: 5, description: "Finalises Gradle config and creates build output" },
    ],
  },
  web: {
    label: "Web Team",
