...
const TEMPLATES = [
  ...
  },
  {
    ...
    description: "Material 3 messaging app with contacts, threads, and offline support.",
    tags: ["chat", "messaging", "material3"], starred: true,
    prompt: "Build an Android chat app using Kotlin and Jetpack Compose with Material 3. Include a contacts list, chat threads, message bubbles, and offline support with Room DB.",
  },
  {
    id: "t8", name: "Android Fitness Tracker", category: "android" as Category,
    description: "Workout logger with exercise library, sets/reps tracking, and history.",
    tags: ["fitness", "health", "tracker"], starred: true,
    prompt: "Build an Android fitness tracker with Kotlin + Jetpack Compose. Include workout logging, exercise library, sets/reps input, and workout history with charts.",
  },
  {
    id: "t9", name: "Android Calculator", category: "android" as Category,
    description: "Material 3 calculator with history, scientific mode, and haptic feedback.",
    tags: ["calculator", "material3"], starred: false,
    prompt: "Build an Android calculator app using Kotlin + Jetpack Compose with Material 3. Include basic and scientific modes, calculation history, and haptic feedback.",
  },
  {
    id: "t10", name: "Android Weather App", category: "android" as Category,
    description: "Beautiful weather app with animated icons and location support.",
    tags: ["weather", "android", "animations"], starred: false,
    prompt: "Build an Android weather app with Kotlin + Jetpack Compose. Beautiful animated weather icons, current conditions, hourly and daily forecast, location-based.",
  },
  {
